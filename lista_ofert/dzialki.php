...
<?php
$dzialki_sql = mysql_query("SELECT * FROM nieruchomosci WHERE typ_nieruchomosci = 'działka' AND id > '4'") or die("dzialki_sql error: ".mysql_error());

$nieruchomosc = new nieruchomosc();
 echo $_SESSIONS['query'];
?>
...
<?php include_once('./tpl/filtr.php'); ?>  
    ...
    <?php 
    while($r = mysql_fetch_assoc($dzialki_sql))
    {
